...
<div class="graff" id="grafico_barras">
    ...
    <div class="titulo">
        <h2 style="font-size: 13px;">Eje estrategico seleccionado en meta 3</h2>
    </div>
    <!-- Resources -->
    <script src="https://cdn.amcharts.com/lib/5/index.js"></script>
    <script src="https://cdn.amcharts.com/lib/5/xy.js"></script>
    ...
    <script>
        am5.ready(function() {
            ...
            var datos = [
                ...
                $sql1 = $conexionGrafico->query("SELECT count(*) as valorq from personaloperativo2023 where ejeestrategico32022 = 'Mejorar la atención al usuario mediante herramientas de comunicación, abrigo y acompañamiento al paciente, potenciando la atención Médica Integral y de calidad centrada en el paciente con orientación familiar y comunitaria con perspectiva de humanismo.'");
                $row1 = mysqli_fetch_assoc($sql1);
                $sql2 = $conexionGrafico->query("SELECT count(*) as valorw from personaloperativo2023 where ejeestrategico32022 = 'Promover la formación del recurso humano impulsando el desarrollo de competencias y habilidades necesarias para la mejora de la atención de las prioridades nacionales en salud.'");
                $row2 = mysqli_fetch_assoc($sql2);
                $sql3 = $conexionGrafico->query("SELECT count(*) as valorr from personaloperativo2023 where ejeestrategico32022 = 'Promover la generación de nuevo conocimiento, a partir del desarrollo de protocolos de investigación multidisciplinarios e interinstitucional en beneficio de la salud.'");
                $row3 = mysqli_fetch_assoc($sql3);
                $sql4 = $conexionGrafico->query("SELECT count(*) as valora from personaloperativo2023 where ejeestrategico32022 = 'Modelo de Desarrollo Organizacional integral.'");
                $row4 = mysqli_fetch_assoc($sql4);
                $sql5 = $conexionGrafico->query("SELECT count(*) as valorf from personaloperativo2023 where ejeestrategico32022 = 'Fiscalización'");
                $row5 = mysqli_fetch_assoc($sql5);
                //$total = $row4['total4'] + $row3['total3'] + $row2['total2'] + $row1['total1'];
                ?>
            ];
...
<div class="graff" id="grafico_pastel">
    ...
    <div class="titulo">
        <h2 style="font-size: 13px;">Porcentaje de eje seleccionado en meta 3</h2>
    </div>
    <!-- Resources -->
    <script src="https://cdn.amcharts.com/lib/5/index.js"></script>
    <script src="https://cdn.amcharts.com/lib/5/percent.js"></script>
