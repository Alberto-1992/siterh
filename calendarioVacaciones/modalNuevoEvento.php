...
<script>
  ...
  document.querySelector('#fecha_inicio').min = fechaMin;
</script>
  ...
  <div class="form-group">
      ...
      <label>Fecha Inicio</label>
        <input type="date" class="form-control" name="fecha_inicio" id="fecha_inicio" onkeydown="return false" placeholder="Fecha Inicio"  min = "<?php echo date("Y-m-d",strtotime(date("Y-m-d")));?>">
      </div>
      <div class="col-sm-10">
      <label>Fecha Final</label>
        <input type="date" class="form-control" name="fecha_fin" id="fecha_fin"  onkeydown="return false" placeholder="Fecha Final" min = "<?php echo date("Y-m-d",strtotime(date("Y-m-d")));?>">
      </div>
    </div>
