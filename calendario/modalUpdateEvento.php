<div class="modal" id="modalUpdateEvento"  tabindex="-1" role="dialog">
  ...
  <form name="formEventoUpdate" id="formEventoUpdate" action="UpdateEvento.php" class="form-horizontal" method="POST">
    ...
    <div class="form-group">
      <label for="lugarevento" class="col-sm-12 control-label">Lugar del Evento</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" name="lugarevento" id="lugarevento" placeholder="Lugar del Evento" required/>
      </div>
    </div>
    <div class="form-group">
