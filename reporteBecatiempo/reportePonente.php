...
$pdf->SetTextColor(0, 0, 0);
$pdf->Ln(2);
$pdf->Cell(200, 4, utf8_decode("Solicito a usted de la manera más atenta, otorgar las facilidades para asistir como ponente al evento académico que se describe:"), 0, 0, "L", 0);
$pdf->SetFont("Arial", "B", 9);
$pdf->SetFillColor(221, 221, 221);
$pdf->SetTextColor(0, 0, 0);
$pdf->ln(5);
