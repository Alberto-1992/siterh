...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    ...
    <div class="containerr2">Estrucutra</div>
...
?>
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%">
    <div class="containerr2" style="background-color: orange;">Información personal</div>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%">
    <div class="containerr2" style="background-color: orange;">Información domicilio</div>
    <tr>
        <th id="th">Calle:</th>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%">
    <div class="containerr2" style="background-color: red;">Datos contacto emergencia</div>
    <tr>
