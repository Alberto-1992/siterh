...
<ul class="nav nav-tabs" style="margin-top: 47px;" >       
            ...
            <ul class="dropdown-menu" style="margin: 0px; font-size: 10px; padding: 0px;">
                ...
                <li><a class="dropdown-item" href="#" onclick="rechazo();">Editar información</a></li>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    ...
    <div class="containerr2" style="background-color: #6947B0;">Datos personales</div>
    <tr>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Estudios medio superior</div>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Estudios nivel superior</div>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Estudios nivel maetria</div>
    <tr>
        <th id="th">Nombre de la formación:</th>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Estudios nivel segunda maetria</div>
    <tr>
        <th id="th">Nombre de la formación:</th>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Posgrado/Especialidad</div>
    <tr>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Nivel Doctorado/Subespecialidad</div>
    <tr>
        <th id="th">Nombre de la formación académica:</th>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Otros estudios/Alta especialidad</div>
    <tr>
        <th id="th">Nombre de la formación académica:</th>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Otros estudios 1</div>
    <tr>
        <th id="th">Nombre de la formación académica:</th>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Otros estudios 2</div>
    <tr>
        <th id="th">Nombre de la formación académica:</th>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Servicio social</div>
    <tr>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
<div class="containerr3" style="background-color: #6947B0;">Practicas profesionales</div>
    <tr>
        <th id="th">Nombre de la dependencia donde se realizó:</th>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Certificación</div>
    <tr>
        <th id="th">Nombre de la institución educativa:</th>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Segunda certificación</div>
    <tr>
        <th id="th">Nombre de la institución educativa:</th>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Actualización academica/primer curso</div>
    <tr>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Segundo curso</div>
    <tr>
        <th id="th">Nombre del curso:</th>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Tercer curso</div>
    <tr>
        <th id="th">Nombre del curso:</th>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Experiencia laboral, sector público</div>
    <tr>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Experiencia laboral, sector público-segundo</div>
    <tr>
        <th id="th">Secretaría de Estado:</th>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Experiencia laboral, sector público-tercero</div>
    <tr>
        <th id="th">Secretaría de Estado:</th>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Experiencia laboral, sector privado</div>
    <tr>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Experiencia laboral, sector privado-segundo</div>
    <tr>
        <th id="th">Nombre de la empresa:</th>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Experiencia laboral, sector privado-tercero</div>
    <tr>
        <th id="th">Nombre de la empresa:</th>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Producción cientifica (Investigación, última publicación)</div>
    <tr>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Idioma</div>
    <tr>
        <th id="th">Idioma:</th>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Otras habilidades</div>
    <tr>
...
<table class="table table-responsive  table-bordered " cellspacing="0" width="100%" >
    <div class="containerr3" style="background-color: #6947B0;">Manifiesto</div>
    <tr>
