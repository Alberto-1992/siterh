...
//{    
    ...
    $QueryConsulta= $conexionGrafico->query("SELECT plantillahraei.*, CASE WHEN plantillahraei.baja = 0 THEN 'Activo' ELSE 'Baja' END as estatus from plantillahraei where plantillahraei.baja = 0"); 
